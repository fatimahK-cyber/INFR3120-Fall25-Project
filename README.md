...
WorkIt is a simple fitness tracker web application built using   Node.js, Express.js, and EJS  . It includes three main pages:   Home ,  Add Workout  , and   My Workouts  . Users can create workouts and delete them.
 ...
 > Designed custom WorkIt logo + branding  
 > Built navigation bar + hero button  
 ...
 > Displayed all workouts using EJS loops  
 > Added Delete button (POST /workouts/:id/delete)  
 > Styled workout cards
...
All code follows examples from INFR3120 course materials 
 ...
 > Static folder setup  
  ...
  From Chapters 8, 9, 10 (Connolly & Hoar):    
 > HTML structure, forms, and semantic layout  
